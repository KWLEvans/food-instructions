 ...
 */
function keithkatietheme_form_system_theme_settings_alter(&$form, &$form_state, $form_id = NULL) {
  ...
  $form['keithkatietheme_example'] = array(
  '#type'          => 'checkbox',
  '#title'         => t('keithkatietheme sample setting'),
  '#default_value' => theme_get_setting('keithkatietheme_example'),
